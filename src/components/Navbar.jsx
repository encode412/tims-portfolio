  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      <ul className='hidden md:flex'>
        ...
        <li>
          <Link to='work' smooth={true} duration={500} className='hover:text-pink-600'>
            Work
          </Link>
        </li>
        <li>
      ...
      <ul
        className= {`${!nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'} flex md:hidden`         
                    }
      >
        ...
        <li className='py-6 text-4xl'>
          {' '}
          <Link onClick={handleClick} to='work' smooth={true} duration={500} className='hover:text-pink-600'>
            Work
          </Link>
        </li>
        <li className='py-6 text-4xl'>
        ...
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600'>
            <a
              ...
              href='https://www.linkedin.com/in/timothy-onyeacholam-12365920a'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://github.com/encode412'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://encode.dev.tech@gmail.com'
            >
